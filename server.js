...
app.get('/admin/usuarios',(_req,res)=>res.sendFile(path.join(publicPath,'admin-users.html')));
...
app.get('/perfil',(_req,res)=>res.sendFile(path.join(publicPath,'profile.html')));
app.get('/pesquisa-web',(_req,res)=>res.sendFile(path.join(publicPath,'research-web.html')));
app.get(/^(?!\/api(?:\/|$)|\/login$|\/signup$|\/admin(?:\/|$)|\/investigacoes$|\/nova-investigacao$|\/investigacao$|\/perfil$|\/pesquisa-web$)/,(_req,res)=>res.sendFile(path.join(publicPath,'index.html')));
